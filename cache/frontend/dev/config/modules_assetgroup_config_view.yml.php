...
if ($templateName.$this->viewName == 'newSuccess')
{
  ...
  $response->addJavascript('jquery_asset_group_form_new', '', array ());
}
else if ($templateName.$this->viewName == 'editSuccess')
{
  ...
  $response->addStylesheet('main.css', '', array ());
  $response->addJavascript('jquery-1.7.2.min.js', '', array ());
  $response->addJavascript('jquery_evaluator_history', '', array ());
  $response->addJavascript('jquery_format_type', '', array ());
}
else
{
  if (null !== $layout = sfConfig::get('symfony.view.'.$this->moduleName.'_'.$this->actionName.'_layout'))
