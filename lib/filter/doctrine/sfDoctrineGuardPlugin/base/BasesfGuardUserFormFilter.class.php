...
abstract class BasesfGuardUserFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'mediascore_access' => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      'mediariver_access' => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ...
    $this->setValidators(array(
      ...
      'mediascore_access' => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
      'mediariver_access' => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
  ...
  public function getFields()
  {
    return array(
      ...
      'phone'             => 'Text',
      'role'              => 'Text',
      'mediascore_access' => 'Boolean',
      'mediariver_access' => 'Boolean',
      'contact_info'      => 'Text',
      'unit_id'           => 'Number',
      'title'             => 'Text',
      'created_at'        => 'Date',
