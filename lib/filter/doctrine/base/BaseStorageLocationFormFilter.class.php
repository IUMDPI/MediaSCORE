...
abstract class BaseStorageLocationFormFilter extends BaseFormFilterDoctrine
{
  ...
  public function addUnitMultipleCollectionListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    if (!is_array($values))
    {
      $values = array($values);
  ...
  public function addCollectionMultipleAssetGroupListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    if (!is_array($values))
    {
      $values = array($values);
  ...
  public function getFields()
  {
    return array(
      ...
      'unit_multiple_collection_list'        => 'ManyKey',
      'collection_multiple_asset_group_list' => 'ManyKey',
    );
  }
}
