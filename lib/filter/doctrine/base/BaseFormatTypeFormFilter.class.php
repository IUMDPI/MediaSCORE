...
abstract class BaseFormatTypeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'generation'                      => new sfWidgetFormFilterInput(),
      'year_recorded'                   => new sfWidgetFormFilterInput(),
      ...
      'tape_type'                       => new sfWidgetFormFilterInput(),
      ...
      'trackConfiguration'              => new sfWidgetFormFilterInput(),
      ...
      'recordingLayer'                  => new sfWidgetFormFilterInput(),
      'recordingSpeed'                  => new sfWidgetFormFilterInput(),
      'cylinderType'                    => new sfWidgetFormFilterInput(),
      'reflectiveLayer'                 => new sfWidgetFormFilterInput(),
      'dataLayer'                       => new sfWidgetFormFilterInput(),
      'opticalDiscType'                 => new sfWidgetFormFilterInput(),
      'format'                          => new sfWidgetFormFilterInput(),
      'recordingStandard'               => new sfWidgetFormFilterInput(),
      'publicationYear'                 => new sfWidgetFormFilterDate(array('from_date' => new sfWidgetFormDate(), 'to_date' => new sfWidgetFormDate())),
      'capacityLayers'                  => new sfWidgetFormFilterInput(),
      'codec'                           => new sfWidgetFormFilterInput(),
      'dataRate'                        => new sfWidgetFormFilterInput(),
      'sheddingSoftBinder'              => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      'formatVersion'                   => new sfWidgetFormFilterInput(),
      'oxide'                           => new sfWidgetFormFilterInput(),
      'binderSystem'                    => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      'reelSize'                        => new sfWidgetFormFilterInput(),
      ...
      'formatTypedVideoRecordingFormat' => new sfWidgetFormFilterInput(),
      'bitrate'                         => new sfWidgetFormFilterInput(),
      'scanning'                        => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'publicationYear'                 => new sfValidatorDateRange(array('required' => false, 'from_date' => new sfValidatorDateTime(array('required' => false, 'datetime_output' => 'Y-m-d 00:00:00')), 'to_date' => new sfValidatorDateTime(array('required' => false, 'datetime_output' => 'Y-m-d 23:59:59')))),
