...
file_put_contents(
        $projectConfigurationFile = $c->tmp_dir . DS . 'config' . DS . 'ProjectConfiguration.class.php', str_replace(
                '$this->enablePlugins(\'sfPropelPlugin\')', '$this->enablePlugins(array(\'myFooPlugin\', \'sfPropelPlugin\'))', file_get_contents($projectConfigurationFile)
        )
);
