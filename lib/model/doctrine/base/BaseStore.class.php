 ...
 * @method text                getInstId()                         Returns the current record's "inst_id" value
 ...
 * @method Store               setIsImported()                     Sets the current record's "is_imported" value
...
abstract class BaseStore extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('inst_id', 'text', null, array(
             'type' => 'text',
             'notnull' => true,
             ));
