 ...
 * @method Pressed78RPMDisc setDurationTypeMethodology()         Sets the current record's "duration_type_methodology" value
 * @method Pressed78RPMDisc setFormatNotes()                     Sets the current record's "format_notes" value
 ...
 * @method Pressed78RPMDisc setFormatId()                        Sets the current record's "format_id" value
 * @method Pressed78RPMDisc setFCName()                          Sets the current record's "f_c_name" value
