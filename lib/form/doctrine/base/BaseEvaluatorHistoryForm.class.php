...
abstract class BaseEvaluatorHistoryForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'evaluator_id'             => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Evaluator'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'evaluator_id'             => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Evaluator'))),
