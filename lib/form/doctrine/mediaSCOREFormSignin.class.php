...
class mediaSCOREFormSignin extends sfGuardFormSignin
{
   ...
   */
	...
	public function configure() {
		...
		$this->setWidget('unit', new sfWidgetFormDoctrineChoice(array('model' => 'Unit' )));
		$this->setWidget('personnel_list',new sfWidgetFormDoctrineChoice(array('model' => 'Person', 'method' => 'getFullName','multiple' => true)));
		$this->setWidget('storage_locations_list', new sfWidgetFormDoctrineChoice(array('multiple' => true, 'model' => 'StorageLocation')));
