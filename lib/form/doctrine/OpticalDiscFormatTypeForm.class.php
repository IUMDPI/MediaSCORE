...
class OpticalDiscFormatTypeForm extends BaseOpticalDiscFormatTypeForm {
    ...
    public function configure() {
        parent::configure();
        $this->setWidget('reflectiveLayer', new sfWidgetFormChoice(array('choices' => OpticalDiscFormatType::$constants[0], 'multiple' => true), array('class' => 'override_required')));
        ...
        $this->setWidget('dataLayer', new sfWidgetFormChoice(array('choices' => OpticalDiscFormatType::$constants[1], 'multiple' => true), array('class' => 'override_required')));
