		...
		foreach ($characteristicsValues as $characteristicsValue)
		{
			...
			if ( ! $constraint_will_be_applied)
			{
				...
				if (strstr($characteristicsValue['CharacteristicsFormat']['format_c_name'], 'oxide'))
				{
					...
					{
						if (strstr(strtolower($this->multiselection_value['Newoxide'][$AssetInformatoin[0]['FormatType'][$characteristicsValue['CharacteristicsFormat']['format_c_name']]]), strtolower($characteristicsValue['c_name'])))
						{
							echo 'oxide = ';
	...
	public function OpenReelVideo2Calc($AssetInformatoin = array(), $characteristicsValues = array())
	{
		...
		foreach ($characteristicsValues as $characteristicsValue)
		{
			...
			if ( ! $constraint_will_be_applied)
			{
				...
				if ($characteristicsValue['CharacteristicsFormat']['format_c_name']== 'format')
				{
					if (isset($AssetInformatoin[0]['FormatType']['format']))
					{
						if (strtolower($this->multiselection_value[$characteristicsValue['CharacteristicsFormat']['format_c_name']][$AssetInformatoin[0]['FormatType'][$characteristicsValue['CharacteristicsFormat']['format_c_name']]])== strtolower($characteristicsValue['c_name']))
						{
							echo 'format = ';
