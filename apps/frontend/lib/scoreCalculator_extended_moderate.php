...
class scoreCalculator_extended_moderate {
    ...
    public function VHSCalc($AssetInformatoin = array(), $characteristicsValues = array()) {
        ...
        foreach ($characteristicsValues as $characteristicsValue) {
            ...
            if (!$constraint_will_be_applied) {
                ...
                if (strstr($characteristicsValue['CharacteristicsFormat']['format_c_name'], 'formatVersion')) {
                    if (isset($AssetInformatoin[0]['FormatType']['formatVersion'])) {
                        if (strstr(strtolower($this->multiselection_value['VHSformatVersion'][$AssetInformatoin[0]['FormatType'][$characteristicsValue['CharacteristicsFormat']['format_c_name']]]), strtolower($characteristicsValue['c_name']))) {
    ...
    public function DVCProCalc($AssetInformatoin = array(), $characteristicsValues = array()) {
        ...
        foreach ($characteristicsValues as $characteristicsValue) {
            ...
            if (strstr($characteristicsValue['CharacteristicsFormat']['format_c_name'], 'formatVersion')) {
                if (isset($AssetInformatoin[0]['FormatType']['formatVersion'])) {
                    if (strstr(strtolower($this->multiselection_value['DVCProformatVersion'][$AssetInformatoin[0]['FormatType'][$characteristicsValue['CharacteristicsFormat']['format_c_name']]]), strtolower($characteristicsValue['c_name']))) {
                        echo 'DVCProformatVersion = ';
                        echo $DVCProformatVersion = $characteristicsValue['c_score'];
                        $this->score = (float) $this->score + (float) $DVCProformatVersion;
                        echo '<br/>';
                        echo '<br/>';
                    }
                }
        ...
        foreach ($characteristicsValues as $characteristicsValue) {
            ...
            if (strstr($characteristicsValue['CharacteristicsFormat']['format_c_name'], 'reelSize')) {
                if (isset($AssetInformatoin[0]['FormatType']['reelSize'])) {
                    if (strstr(strtolower($this->multiselection_value['HalfInchReelSize'][$AssetInformatoin[0]['FormatType'][$characteristicsValue['CharacteristicsFormat']['format_c_name']]]), strtolower($characteristicsValue['c_name']))) {
                        echo 'reelSize = ';
