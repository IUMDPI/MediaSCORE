<table>
  <tbody>
    <tr>
      <th>Id:</th>
      <td><?php echo $optical_video->getId() ?></td>
    </tr>
    <tr>
      <th>Quantity:</th>
...
<a href="<?php echo url_for('opticalvideo/edit?id='.$optical_video->getId()) ?>">Edit</a>
&nbsp;
<a href="<?php echo url_for('opticalvideo/index') ?>">List</a>
