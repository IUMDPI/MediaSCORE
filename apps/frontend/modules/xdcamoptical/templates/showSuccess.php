<table>
  <tbody>
    <tr>
      <th>Id:</th>
      <td><?php echo $xd_cam_optical->getId() ?></td>
    </tr>
    <tr>
      <th>Quantity:</th>
...
<a href="<?php echo url_for('xdcamoptical/edit?id='.$xd_cam_optical->getId()) ?>">Edit</a>
&nbsp;
<a href="<?php echo url_for('xdcamoptical/index') ?>">List</a>
