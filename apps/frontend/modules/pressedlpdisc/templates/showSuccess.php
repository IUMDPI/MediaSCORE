<table>
  <tbody>
    <tr>
      <th>Id:</th>
      <td><?php echo $pressed_lp_disc->getId() ?></td>
    </tr>
    <tr>
      <th>Quantity:</th>
...
<a href="<?php echo url_for('pressedlpdisc/edit?id='.$pressed_lp_disc->getId()) ?>">Edit</a>
&nbsp;
<a href="<?php echo url_for('pressedlpdisc/index') ?>">List</a>
