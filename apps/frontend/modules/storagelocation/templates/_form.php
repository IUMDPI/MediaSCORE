    ...
    <table>
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <?php echo $form['name']->render(); ?> <div class="help-text">The name commonly used to refer to the storage location.</div>
            ...
            <tr>
                ...
                <td>
                    <?php echo $form['resident_structure_description']->render(); ?> <div class="help-text">Select the environment that best describes the environment for this storage location. See help documentation for guidance.</div>
